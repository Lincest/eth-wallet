...
func TestKeystoreService_GenerateOneKeyStoreFile(t *testing.T) {
	if err := KeyStore.GenerateOneKeyStoreFile("ee6030fcdcb30fbc3459456e7ef820c4c5c78e24fac11a2c886edec0bf1fb46f", "123"); err != nil {
		t.Fail()
	}
}
...
func TestKeystoreService_GenerateKeyStoreFiles(t *testing.T) {
	...
	if err := KeyStore.GenerateKeyStoreFiles(privateKeyList, "123"); err != nil {
		t.Fail()
	}
}
